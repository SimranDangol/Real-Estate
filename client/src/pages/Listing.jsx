...
export default function Listing() {
  ...
  return (
    <main className="bg-white dark:bg-gray-900">
      {loading && (
        <p className="text-2xl text-center text-gray-900 my-7 dark:text-white">
          Loading...
        </p>
      )}
      {error && (
      ...
      {listing && !loading && !error && (
        <div>
          ...
          {copied && (
            <p className="fixed top-[23%] right-[5%] z-10 rounded-md bg-slate-100 dark:bg-gray-700 text-gray-900 dark:text-white p-2">
              Link copied!
            </p>
          )}
          <div className="flex flex-col max-w-4xl gap-4 p-3 mx-auto my-7">
            ...
            <p className="flex items-center gap-2 mt-6 text-sm text-slate-600 dark:text-gray-300">
            ...
            <ul className="flex flex-wrap items-center gap-4 text-sm font-semibold text-green-900 dark:text-green-300 sm:gap-6">
